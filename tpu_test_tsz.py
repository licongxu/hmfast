...
def main():
    ...
    # Grid definition
    m = jnp.logspace(10, 15, 64) # Mass grid
    z = jnp.linspace(0.01, 3.0, 32) # Redshift grid
    ell = jnp.logspace(jnp.log10(10), jnp.log10(10000), 50) # Multipole grid
    ...
    # Block until ready forces JAX to finish async execution before timing
    ...
    output_path = f"tsz_spectrum_{jax.default_backend()}.png"
